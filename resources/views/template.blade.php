...
<head>
    ...
    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/vendor/fontawesome-free/css/all.min.css" type="text/css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i">

    <!-- Custom styles for this template-->
    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/css/sb-admin-2.min.css">

    <!-- Custom styles -->
    <link rel="stylesheet" href="{{ env('APP_URL') }}/assets/css/custom-style.css">
    </head>
...
<body class="bg-gradient-primary">
    ...
    <script src="{{ env('APP_URL') }}/assets/js/sb-admin-2.min.js"></script>
</body>
</html>
